...
function ActiveCard() {
  ...
  // Không dùng biến state để check đóng mở modal nữa vì chúng ta sẽ check theo cái biến showModalActiveCard trong redux
  ...
  // Function gọi API dùng chung cho các trường hợp update card title, description, cover, content,....
  ...
  // Dùng async await ở đây để component con CardActivitySection chờ và nếu thành công mới clear thẻ input comment
