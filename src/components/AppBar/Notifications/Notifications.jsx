...
function Notifications() {
  ...
  // Láy dữ liệu notifications từ trong Redux
  ...
  useEffect(() => {
    ...
    // Tạo một function xử lí khi nhận được sự kiện real-time, docs hướng dẫn
    ...
    const onReceiveNewInvitation = (invitation) => {
      ...
      if (invitation.inviteeId === currentUser._id) {
        ...
        // Bước 2: Cập nhật trạng thái đang có thông báo mới
    ...
    // Clean Up event để ngăn chặn việc bị đăng kí lặp lại event
