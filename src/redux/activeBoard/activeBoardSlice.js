    ...
    updateCardInBoard: (state, action) => {
      ...
      if (column) {
        ...
        if (card) {
          ...
          // Dùng Objetc.keys để lấy toàn bộ cái properties (keys) của incomingCard về một Array rồi forEach nó ra
          // Sau đó tùy vào trường hợp cần thì kiểm tra thêm còn không thì cập nhật ngựo lại giá trị vào card luôn như bên dưới
