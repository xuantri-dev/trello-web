...
// Xử lí custom đẹp cái input file ở đây https://mui.com/material-ui/react-button/#file-upload
// Ngoài ra note thêm lib này từ docs của MUI nó recommend nếu cần đùng: https://github.com/viclafouch/mui-file-input
...
function AccountTab() {
  ...
  // Những thông tin của user để init vào form (key tương ứng với regiser phía dưới Field)
  ...
  const uploadAvatar = (e) => {
    ...
    // Sử dụng FormData để xử lí dữ liệu liên quan tới file khi gọi API
