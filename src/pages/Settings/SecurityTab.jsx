...
import { updatedUserAPI, logoutUserAPI } from '~/redux/user/userSlice'
...
function SecurityTab() {
  ...
  const submitChangePassword = (data) => {
    confirmChangePassword({
      // Title, Description, Content,...vv của gọi material-ui-confirm đều có type là ReactNode nên có thể thoải mái sử dụng MUI components, rất tiện lợi khi cần custom styles
      title: <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }} >
        <LogoutIcon sx={{ color: 'warning.dark' }} /> Change Password
      </Box>,
      description: 'You have to login again after succesfully changing your password. Continue?',
      ...
      toast.promise(
        ...
        if (!res.error) {
          toast.success('Successfully changed your password, please log in again')
